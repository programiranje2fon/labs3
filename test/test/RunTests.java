...
import p1.ComplexCalculatorTest;
import p2.ComplexCalculator2Test;
...
public class RunTests {
	...
	public static void main(String[] args) {
		runTestsForClass(ComplexCalculatorTest.class);
		runTestsForClass(ComplexCalculator2Test.class);
	}
